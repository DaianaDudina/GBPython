...
string1 = input("Строка1>>> ")
number2 = int(input("Число2>>>"))
string2 = input("Строка2>>> ")
print(number1, string1, number2, string2, a, b)
...
while n > 0:
    if n % 10 > max:
        max = n % 10
    n = n // 10
print("Самая большая цыфра в числе >>>", max)
